...
export function Results() {
  ...
  return (
    <section id="results" className="py-28 sm:py-36 bg-[#0a141d] border-t border-white/10 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div data-stagger className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl lg:text-[2.5rem] font-medium font-serif tracking-tight text-white leading-[1.08]">
              ...
              <span className="font-medium text-[#8fc7d4]">It's one that belongs there.</span>
            </h2>
            <p className="mt-4 text-base sm:text-lg text-[#a7c2cb] font-light leading-relaxed">
            ...
            {BEFORE_AFTER_CASES.map((c, idx) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-medium transition-all cursor-pointer ${
                  idx === selectedCaseIdx
                    ? 'bg-[#8fc7d4] text-[#0a141d] shadow-xs'
                    : 'text-[#7f9aa4] hover:text-white'
                }`}
              >
                Case 0{idx + 1}
              </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div data-reveal="left" className="lg:col-span-8">
            <div
              className="relative aspect-[16/10] sm:aspect-[16/9] w-full rounded-2xl overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.35)] border border-white/10 select-none cursor-ew-resize bg-[#0a141d]"
            ...
            >
              ...
              />
              <div className="absolute top-4 right-4 bg-[#101715]/80 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-medium text-white shadow-md">
                Restored Smile
              </div>
              ...
              >
                <img
                  ...
                  referrerPolicy="no-referrer"
                />
                <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md px-3.5 py-1.5 rounded-full text-xs font-medium text-[#101715] shadow-md">
                  Initial Condition
                </div>
              </div>
              ...
              >
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#0a141d] shadow-xl border border-white/10">
              ...
              <div className="absolute bottom-4 inset-x-0 flex justify-center pointer-events-none">
                <div className="flex items-center gap-1.5 rounded-full bg-[#101715]/75 px-3.5 py-1 text-[11px] text-white/90 backdrop-blur-md">
            ...
            <p className="mt-3 text-xs text-[#7f9aa4] italic">
          ...
          <div data-reveal="right" className="lg:col-span-4 flex flex-col justify-between rounded-2xl bg-white/[0.05] backdrop-blur-md p-8 border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
            <div>
              ...
              <p className="text-sm text-[#a7c2cb] leading-relaxed font-light mb-6">
              ...
              <div className="space-y-3 pt-6 border-t border-white/10">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#7f9aa4]">Patient Demographic</span>
                  <span className="font-semibold text-white">{activeCase.patientAge}</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#7f9aa4]">Treatment Duration</span>
                  <span className="font-semibold text-white">{activeCase.treatmentDuration}</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#7f9aa4]">Ceramic Shade</span>
                  <span className="font-semibold text-white">{activeCase.shade}</span>
                </div>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#7f9aa4]">Implant Platform</span>
                  <span className="font-semibold text-white">{activeCase.implantType}</span>
                </div>
              </div>
            </div>

            <div className="mt-8 pt-6 border-t border-white/10 flex items-center gap-2 text-xs text-[#8fc7d4]">
