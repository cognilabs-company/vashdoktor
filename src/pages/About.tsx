  ...
  return (
    <>
      ...
      <section className="relative w-full border-t border-white/10 bg-[var(--c-bg)] py-20 lg:py-28">
        <div data-scroll className="mx-auto grid max-w-[1440px] items-center gap-12 px-6 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:px-12">
          ...
          <div className="sp-3d sp-pair grid grid-cols-2 gap-4" style={{ ['--sp-cn' as string]: 1 }}>
            {STATS.map((s) => (
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {VALUES.map((v, i) => (
              <div
                key={v.title}
                data-scroll
                className="sp-3d sp-grid-4 group rounded-2xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-md transition-[translate,border-color,background-color] duration-300 hover:-translate-y-1 hover:border-[var(--c-accent)]/40"
